...
The files-api service is a RESTful web service used to access file information and register files. A description of the API calls is found here: [Files API](https://smart-api.info/ui/ea21748ce0c9197ed0f2e85c6b507e2f).
